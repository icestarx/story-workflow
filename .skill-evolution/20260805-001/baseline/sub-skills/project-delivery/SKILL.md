...
调用 canon-management 核对并更新 01-canon/context.md、foreshadow-ledger.md、timeline.md、state.md。运行：

    python scripts/generate_project_report.py --project-dir path/to/project --force

将项目摘要、Canon 版本、锁定章节、未决项、开放伏笔、审计结论和文件清单写入 07-release/project-summary.md。展示生成的 manifest 与报告，再记录用户的项目完成确认或保留项。
