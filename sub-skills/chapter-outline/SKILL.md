...
先读取对应卷纲、长线账本、前后章节索引和相关 Canon。依 [章节细纲契约](../../references/chapter-contract.md) 写入 chapter-NNNN.md 的全部必填标题。随后运行：

    python scripts/validate_outline.py --outline path/to/chapter-0001.md
