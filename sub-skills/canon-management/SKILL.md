...
读取 01-canon/registry.json 及相关 Markdown，运行：
...
3. 取得用户批准或核对已有明确授权；
4. 同步更新 core-settings.md、registry.json、context.md、state.md、timeline.md、foreshadow-ledger.md、chapter-index.md 与相关 Markdown；
...
它生成 05-reviews/impact-<id>.md，列出显式受影响事实、已发布文本、未来细纲和审校文件。补充逻辑/主题/读者预期的隐含影响、替换办法、读者可见风险和回退方案。批准前不可覆盖旧事实；批准后保留历史版本与迁移状态，并运行 run_regression_suite.py。
