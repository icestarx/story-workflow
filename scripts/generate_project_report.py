...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, help="Default: 07-release/project-summary.md")
    ...
    output = args.output or project / "07-release/project-summary.md"
    ...
    inventory = {
        "volumes": files(project, "02-planning/volumes", "volume-*.md"),
        "outlines": files(project, "03-outlines", "chapter-*.md"),
        "manuscripts": files(project, "04-manuscript", "chapter-*.md"),
        "reviews": files(project, "05-reviews", "*.md") + files(project, "05-reviews/final", "*.md"),
    }
    lines = [
        "# 项目交付总结",
        "",
    ...
    for label, entries in inventory.items():
        ...
        lines.append("")
    lines.extend(["## 未决项与开放伏笔", "", "- 请从 01-canon/context.md、foreshadow-ledger.md 和最终审计报告补充。", ""])
